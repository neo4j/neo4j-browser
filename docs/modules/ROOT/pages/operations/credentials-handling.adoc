...
The timeout is configured in the setting link:https://neo4j.com/docs/operations-manual/current/configuration/configuration-settings/#config_browser.credential_timeout[`browser.credential_timeout`^].
...
To disable credentials caching, set link:https://neo4j.com/docs/operations-manual/current/configuration/configuration-settings/#config_browser.retain_connection_credentials[`browser.retain_connection_credentials=false`^] in the server configuration.
