...
Neo4j Browser provides support for Single Sign-On (SSO) providers under specific Enterprise environment configurations.
...
With the prerequisites in place, you need to update the link:https://neo4j.com/docs/operations-manual/current/configuration/neo4j-conf/#neo4j-conf[`neo4j.conf`^] file with the following information:
