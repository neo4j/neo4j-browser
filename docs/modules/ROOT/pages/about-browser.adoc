...
Executed query results are displayed in a Result Frames offering the flexibility to view them in the format most appropriate to your query, be it a graph visualisation, a table or a data structure of your results.
