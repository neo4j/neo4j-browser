...
For more information, see link:https://neo4j.com/docs/desktop-manual/1.0/visual-tour/#files[Neo4j Desktop Manual -> Files].
...
For more information on how to adjust Browser Settings, see xref:operations.adoc#adjust-settings[Adjust Browser settings].
