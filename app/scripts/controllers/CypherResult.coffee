...
angular.module('neo4jApp.controllers')
  .controller 'CypherResultCtrl', ['$rootScope', '$scope', 'AsciiTableFactory', 'BigNumberHelpers',  ($rootScope, $scope, AsciiTableFactory, BigNumberHelpers) ->
    ...
    $scope.loadAscii = () ->
      ...
      rows = tableData.data.map((data_obj) -> return BigNumberHelpers.mapBigIntsToStrings(data_obj.row))
