...
Running Neo4j Browser locally requires Node.js (lts/gallium), you can install it with `nvm install` on the root of the repo, and for dependencies we use yarn (`npm install -g yarn`).
