...
describe('DatabaseInfo', () => {
  ...
  describe('labels', () => {
    it('should not show labels when there are no labels', () => {
      const labels = []
      const wrapper = shallow(<DatabaseInfoComponent labels={labels}/>)
    ...
    it('should call on click callback with correct cypher * label is clicked', () => {
      const labels = ['Person']
      const wrapper = shallow(<DatabaseInfoComponent labels={labels} onItemClick={onItemClick}/>)
  ...
  describe('relationshipTypes', () => {
    it('should not show relationshipTypes when there are no relationshipTypes', () => {
      ...
      const wrapper = shallow(<DatabaseInfoComponent relationshipTypes={relationshipTypes}/>)
    ...
    it('should call on click callback with correct cypher when * relationship is clicked', () => {
      ...
      const wrapper = shallow(<DatabaseInfoComponent relationshipTypes={relationshipTypes} onItemClick={onItemClick}/>)
  ...
  describe('properties', () => {
    it('should not show properties when there are no properties', () => {
      const properties = []
      const wrapper = shallow(<DatabaseInfoComponent properties={properties}/>)
    ...
    it('should call on click callback with correct cypher when property is clicked', () => {
      ...
      const wrapper = shallow(<DatabaseInfoComponent properties={properties} onItemClick={onItemClick}/>)
