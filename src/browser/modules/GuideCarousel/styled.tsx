...
export const StyledCarouselButtonContainer = styled.div`
  color: ${dark.secondaryButtonText};
  display: flex;
  align-items: center;
...
const CarouselIndicator = styled.li`
  ...
  > span {
    background-color: ${dark.secondaryButtonText};
    display: block;
    border-radius: 3px;
    width: 6px;
    height: 6px;
  ...
  &::before {
    ...
    color: ${dark.primaryBackground};
    background-color: ${dark.primaryText};
    position: absolute;
    font-size: 12px;
    font-weight: bold;
    left: 50%;
  ...
  &::after {
    border: solid;
    border-color: ${dark.primaryText} transparent;
...
`
export const StyledGuideSlide = styled.div`
