...
import { getBuiltAt, getGitRevision } from 'shared/modules/app/appDuck'
import { copyToClipboard } from 'browser-components/ClipboardCopier'
...
const mapStateToProps = (state: any) => {
  return {
    ...
    gitRevision: getGitRevision(state)
  }
}
