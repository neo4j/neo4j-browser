...
const slides = [
  ...
  <SidebarSlide key="s3">
    ...
    <p>
      A result frame is created for each command execution, added to the top of
      the stream to create a scrollable collection in reverse chronological
      order.
    </p>
    <ul>
  ...
  <SidebarSlide key="s4">
    ...
    <br />
    <img src="./assets/images/ReusableFrame2.gif" className="img-responsive" />
  </SidebarSlide>,
  <SidebarSlide key="s5">
    ...
    <code className="nobreak">neo4j default</code> database, shown by the neo4j$
    prompt in the editor.
    <br />
    <img src="./assets/images/SidebarDB_Iinfo.png" className="img-responsive" />
  </SidebarSlide>,
  <SidebarSlide key="s6">
