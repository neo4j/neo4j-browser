...
const icons = {
  ...
  Filter:
    '<svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><g class="icon" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="26"><defs><style>.stroke26{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:26px;}</style></defs><title>Filter</title><path class="stroke26" d="m448 256c0-106-86-192-192-192s-192 86-192 192 86 192 192 192 192-86 192-192z" stroke-miterlimit="10"/><path class="stroke26" d="m144 208h224"/><path class="stroke26" d="m176 272h160"/><path class="stroke26" d="m224 336h64"/></g></svg>'
}
