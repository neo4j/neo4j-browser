...
import { GraphEventHandlerModel } from 'neo4j-arc/graph-visualization/GraphVisualizer/Graph/GraphEventHandlerModel'
...
> {
  ...
  filterNodeNeighbours: GraphEventHandlerModel['filterNodeNeighbours'] = (
    ...
    return this.props.fetchNeighbours(node.id).then((result: any) => {
      this.setState({
